package com.jd.omni.membership.domain.util;



import com.jd.omni.membership.common.exception.SystemException;
...
public class IpUtils {
    ...
    public static String getIp() {
        ...
        try {
            ...
            throw new SystemException("001","当前机器上所有的网络接口",ex);
        }
    ...
    public static String getHostName() {
        try {
            ...
            throw new SystemException("002","获取主机名称异常",ex);
        }
    }
}
